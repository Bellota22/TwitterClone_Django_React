...
function Chat() {
    ...
    const token_verify =jwt_decode(localStorage.getItem('access'))
    const me = token_verify.username
    ...
    const { sendJsonMessage } = useWebSocket(`ws://127.0.0.1:8080/ws/${user}/${me}/`,{
        onOpen: () => {
        ...
        onMessage: (e) => {
            ...
            switch (data.type) {
                ...
                default:
                    console.error('received unkown message type', data.type)
                    break
            }
        }
    }) 
